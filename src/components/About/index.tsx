...
import WallpaperSrc from '../../../public/wallpaper.avif';
    ...
    return (
        <div className={styles.Container}>
            <div className={styles.Background}>
                <Image src={WallpaperSrc} alt='Wallpaper' priority fill={true} />
                <Starfield />
            </div>
            <div className={styles.Main}>
                <Greeting />
                <p className={styles.Text}>
                    Seja bem-vindo(a) a este pequeno espaço do universo — também conhecido como meu
                    portfólio.
                </p>
                <p className={styles.Text}>
                    Não há buracos negros aqui, mas há alguns projetos orbitando ideias e cafeína.
                    ☕
                </p>
                <Link className={styles.Button} href='#me'>
                    Explorar{' '}
                    <svg
                        version='1.1'
                        x='0px'
                    ...
                    >
                        <g className={styles.Wrap}>
                            <g className={styles.Inner}>
                                <path
                                    className={`${styles.Fire} ${styles.FirePath} ${styles.FireMiddle}`}
                                ...
                                />
                                <path
                                    className={`${styles.FirePath} ${styles.Fire} ${styles.FireRight}`}
                                ...
                                />
                                <path
                                    className={`${styles.FirePath} ${styles.Fire} ${styles.FireLeft}`}
                                ...
                                />
                                <path
                                    className={`${styles.FirePath} ${styles.Fire} ${styles.FireSmallLeft}`}
                                ...
                                />
                                <path
                                    className={`${styles.FirePath} ${styles.Fire} ${styles.FireSmallRight}`}
                                ...
                                <g id='large_window_wrap'>
                                    ...
                                    >
                                        <stop offset='0' className={styles.WindowGradient} />
                                        <stop offset='0.5868' className={styles.WindowGradient} />
                                        <stop offset='0.6834' className={styles.WindowGradient} />
                                        <stop offset='0.6845' className={styles.WindowGradient1} />
                                        <stop offset='0.6861' className={styles.WindowGradient2} />
                                        <stop offset='0.6897' className={styles.WindowGradient3} />
                                    </radialGradient>
                                    <circle
                                        className={styles.WindowPathLarge}
                                        cx='148.9'
                                        cy='111.3'
                                        r='10.5'
                                    />
                                ...
                                <circle
                                    className={styles.WindowPathSmall}
                                    cx='148.9'
                                    cy='132.4'
                                    r='5.2'
                                />
